...
dependencies {
    ...
    // Compose dependencies (no version needed - comes from BOM)
    ...
    // Material Components (for non-Compose views)
    ...
    // Core KTX (using versions from libs.versions.toml where possible)
